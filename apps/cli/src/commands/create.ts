...
import { DOCS_URL, KLAVE_CYAN } from '../lib/constants';
...
export const desc: string = '📘 Create a new Klave project';
...
export const handler = async (argv: Arguments<Options>) => {
    const { target, source, withReadme, withChangelog, example } = argv;
    ...
    printFurtherInstructions(targetDir, packageManager, example);
};
...
function printFurtherInstructions(
    ...
    console.log(`Visit ${KLAVE_CYAN.bold(DOCS_URL)} for the documentation on the Klave Network`);
}